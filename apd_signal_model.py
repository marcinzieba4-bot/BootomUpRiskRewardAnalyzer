...
FLOOR_DATA = {
    "trough_2022":        210.0,
    "cum_fcf_per_share":  18.0,
    "debt_delta":         40.6,     # +ve = debt grew (EPP lower); -ve = balance sheet improved
    "structural_delta":   -20.0,  # +ve = fundamentals improved; -ve = structurally weaker
...
print(f"  \u26a0  EPP < CPI-adj trough: $13.5B H2 megaproject capex at risk of write-down.")
print(f"          New CEO strategy reset adds execution uncertainty.")
