...
FLOOR_DATA = {
    ...
    "debt_delta":         2.0,   # +ve = debt grew (floor lower); -ve = balance sheet improved
...
print(f"  \u26a0  Stock is trading BELOW floor — China brand loss may be a permanent impairment,")
print(f"          not a cyclical trough. Floor assumes earnings-power can be restored.")
