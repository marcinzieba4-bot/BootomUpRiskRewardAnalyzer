...
FLOOR_DATA = {
    "trough_2022":        160.0,
    "cum_fcf_per_share":  42.0,
    "debt_delta":         -1.9,     # +ve = debt grew (EPP lower); -ve = balance sheet improved
    "structural_delta":   -5.0,  # +ve = fundamentals improved; -ve = structurally weaker
