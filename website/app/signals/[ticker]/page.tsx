...
const KNOWN_TICKERS = [
  ...
  'CRM','ORCL','CSCO','SAP','NOW','ACN','KTY','IBM','AMD','ADBE','ALE','INTU','QCOM','CDR',
  'TXN','PANW','PLTR','INTC','CAT','MRVL','DHR','PFE','ABT','TMO','MRK','ABBV',
  'JNJ','UNH','LLY','PKN','PKO','PZU','XTB','SYK','BSX','AMGN','ELV','VRTX','GILD','BMY','MA','V',
  'JPM','AXP','GS','WFC','SPGI','PGR','C','BX','FISV','SCHW','MRSH','CB','KKR',
  'PYPL','LIN','APD','SHW','PPG','FCX','ECL','BLK','MS','BAC','BRK','NEM','VMC',
  'CTVA','DOW','LYB','NFLX','GOOGL','META','KNEBV','DNP','T','TTWO','CMCSA','TMUS','VZ','EA','CHTR','WBD','PSX','OKE','XOM','COP','CVX','SLB','KMI','MPC','BKR','TRGP','VLO','OXY','FANG','HAL','DVN','GE','RTX','HON','UNP','ETN','BA','UBER','DE','LMT','GEV','UPS','TT','PH','WM','TDG','EMR','MMM','COST','WMT','DSV','PG','KO','PEP','PM','MCD','CL','FERG','ATCOA','HCA','MO','MDLZ','TGT','MNST','KHC','MSFT','KGH','LPP','ZAB',
];
