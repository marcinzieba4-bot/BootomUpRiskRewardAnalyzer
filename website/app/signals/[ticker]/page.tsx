...
const KNOWN_TICKERS = [
  ...
  'CTVA','DOW','LYB','NFLX','GOOGL','META','KNEBV','DNP','T','TTWO','CMCSA','TMUS','VZ','EA','CHTR','WBD','PSX','OKE','XOM','COP','CVX','SLB','KMI','MPC','BKR','TRGP','VLO','OXY','FANG','HAL','DVN','GE','RTX','HON','UNP','ETN','BA','UBER','DE','LMT','GEV','UPS','TT','PH','WM','TDG','EMR','MMM','COST','WMT','DSV','PG','KO','PEP','PM','MCD','CL','FERG','ATCOA','HCA','MO','MDLZ','TGT','MNST','KHC',
];
