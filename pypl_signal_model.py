...
FLOOR_DATA = {
    ...
    "debt_delta":         -2.7,   # +ve = debt grew (floor lower); -ve = balance sheet improved
...
print(f"  \u26a0  Stock is trading BELOW floor — OS-level displacement (Apple/Google) is")
print(f"          structural. FCF floor may overstate true downside support.")
